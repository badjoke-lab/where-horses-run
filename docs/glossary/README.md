...
`MASTER-006` wave 6 is now active. The search layer is kept separate from canonical knowledge and currently contains **584 reviewed non-canonical queries**: 406 EN/JA direct-definition queries covering all **203 P0 Concepts**, 40 EN/JA comparison queries covering all **20 current reviewed Concept relations**, 28 EN/JA regional-usage queries covering **14 curated source-verified regional label/use cases**, 16 EN/JA how/why queries covering **8 authority-backed explanatory cases**, 28 EN/JA translation queries covering **14 source-verified local/original-script label cases**, plus 33 abbreviation lookups and 33 racecard-reading lookups. All seven intent classes now have reviewed seed coverage; selective classes remain curated rather than blanket-generated.
