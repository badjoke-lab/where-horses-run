...
- Switzerland must remain split between Suisse Trot replay evidence and White Turf St. Moritz event-only live evidence. Neither record verifies complete national Swiss live coverage; White Turf is event-only and Suisse Trot is replay-focused.
