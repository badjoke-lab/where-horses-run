...
export const reviewedRacingMediaLinks: readonly RacingMediaLink[] = [
  ...
  },
  {
    ...
    access_note_ja: 'JCSA公式案内では全競走をDAZNで無料ライブ視聴可能',
  },
  {
    ...
    label_en: 'YouTube',
    label_ja: 'YouTube',
    access_note_en: 'JCSA provides an official YouTube live route. Coverage is kept as selected until all-meeting coverage is independently confirmed.',
    access_note_ja: 'JCSA公式YouTubeライブ。全開催配信が確認できるまでは一部配信扱い',
  },
  {
