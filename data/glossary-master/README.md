...
`GLOSSARY-MASTER-006` wave 6 is now in progress. The separate search-intent layer contains **584 reviewed non-canonical query records**: **406 EN/JA definition queries covering all 203 P0 Concepts**, **40 EN/JA comparison queries covering all 20 current reviewed Concept relations**, **28 EN/JA regional-usage queries covering 14 curated source-verified regional label/use cases**, **16 EN/JA how/why queries covering 8 authority-backed explanatory cases**, **28 EN/JA translation queries covering 14 source-verified local/original-script label cases**, plus 33 abbreviation and 33 racecard-reading queries. All seven intent classes now have reviewed seed coverage, but selective coverage remains intentionally curated. The MASTER-006 gate remains **HOLD** because French code review and worldwide domain/jurisdiction/language readiness audits are still incomplete.
