...
assert.equal(workflow.split('node scripts/timetable/run-brazil-jcb-reunioes-official-window.mjs').length - 1, 2, 'Brazil JCB Reuniões must be collected in both normal and latest-main rebuild paths');
