...
assert.equal(brazilCanonicalIds.length, 2, 'Brazil current automatic Calendar scope must expose Gávea and Cristal as canonical active physical racecourses');
