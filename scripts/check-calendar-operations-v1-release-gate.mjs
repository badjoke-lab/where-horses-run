...
for (const [file, text, markers] of [
  ['START-HERE.md', startHere, ['WHR-CAL-JAPAN-A-PLUS-RECONCILE', 'WHR-CAL-JAPAN-JRA-A-PLUS', 'WHR-CAL-JAPAN-NAR-A-PLUS', 'Current Work ID: `WHR-CAL-HONG-KONG-HKJC`', 'Next source-specific Work ID: `WHR-CAL-UAE-ERA`', 'docs/calendar/japan-a-plus-reconciliation-plan.md', 'docs/calendar/incremental-coverage-contract.md']],
