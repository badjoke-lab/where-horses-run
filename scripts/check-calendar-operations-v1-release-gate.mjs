...
for (const [file, text, markers] of [
  ...
  ['docs/calendar/implementation-roadmap.md', implementationRoadmap, ['Operations v1 status: complete', 'Current Work ID: `WHR-CAL-JAPAN-NAR-A-PLUS`', 'Next Work ID: `WHR-CAL-JAPAN-BANEI-A-PLUS`', 'Coverage Observation']]
]) {
