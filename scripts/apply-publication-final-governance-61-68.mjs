...
patch('scripts/check-country-page-programme.mjs', [
  ...
  [
    ...
    '{ published: 68, profile_ready: 0, source_tested: 0, note_reviewed: 0, page_qa: 0, not_started: 30 }',
    'counts'
  ],
  [
    "console.log('PROGRAMME_COUNTS: published=60 page_qa=8 profile_ready=0 source_tested=0 note_reviewed=0 not_started=30');",
    "console.log('PROGRAMME_COUNTS: published=68 page_qa=0 profile_ready=0 source_tested=0 note_reviewed=0 not_started=30');",
    'log'
  ]
]);

patch('scripts/check-country-page-programme-roadmap.mjs', [
  ["'Publication gate: PR #329',", "'Publication gate: PR #333',", 'publication gate'],
  ["'Current Work ID: WHR-PUB-61-68',\n  'Next working branch: country-publish-61-68',", "'Current Work ID: WHR-ST2-69-76',\n  'Next working branch: source-test-v2-69-76',", 'current work'],
  ["'Latest country publication: PR #329',", "'Latest country publication: PR #333',", 'latest publication'],
  [
...
patch('scripts/check-calendar-contracts.mjs', [
  [
    ...
    "[paths.roadmap, roadmapText, ['Current Work ID: `WHR-ST2-69-76`', 'Next Work ID: `WHR-NOTE-69-76`']]",
    'roadmap IDs'
  ],
  [
    "[paths.startHere, startHereText, ['WHR-PUB-61-68', 'WHR-ST2-69-76']]",
    "[paths.startHere, startHereText, ['WHR-ST2-69-76', 'WHR-NOTE-69-76']]",
    'START IDs'
  ],
  [
    "console.log('CURRENT_WORK_ID: WHR-PUB-61-68');\nconsole.log('NEXT_WORK_ID: WHR-ST2-69-76');",
    "console.log('CURRENT_WORK_ID: WHR-ST2-69-76');\nconsole.log('NEXT_WORK_ID: WHR-NOTE-69-76');",
    'logs'
  ]
]);
...
patch('scripts/check-project-governance-docs.mjs', [
  ...
  [
    ...
    "'START-HERE.md': ['WHR-ST2-69-76', 'WHR-NOTE-69-76', 'calendar-readiness-registry.json'],",
    'START IDs'
  ],
  [
    "console.log('CURRENT_WORK_ID: WHR-PUB-61-68');\nconsole.log('NEXT_WORK_ID: WHR-ST2-69-76');",
...
console.log('APPLIED_PUBLICATION_FINAL_GOVERNANCE_61_68');
