...
const base = {
  ...
  records: [{
    ...
    source_id: 'authority-notice', official_source_url: 'https://authority.example/cancelled', checked_at: '2026-09-21T12:00:00Z', reviewed_at: '2026-09-21'
  }]
};
...
assert.throws(() => validateMeetingPresenceRegistry({...base, records:[{...base.records[0], source_id:null}]}), /source_id/);
assert.throws(() => validateMeetingPresenceRegistry({...base, records:[{...base.records[0], official_source_url:null}]}), /official_source_url/);
assert.throws(() => validateMeetingPresenceRegistry({...base, records:[{...base.records[0], checked_at:null}]}), /checked_at/);
