...
const taifHtml='<html><body><h1>King Khalid Racecourse, Taif</h1><p>Taif Racing Season 2026 runs from 24 July to 26 September 2026</p><div>Meeting 19 King Faisal Cup Race Meeting King Khalid Racecourse Friday, 25th September 2026</div><div>Meeting 20 Taif Season Finale Race Meeting King Khalid Racecourse Saturday, 26th September 2026</div></body></html>';
...
assert.deepEqual(fixtures.map(x=>[x.meeting_no,x.date]),[[19,'2026-09-25'],[20,'2026-09-26']]);
const fixtureRecord=buildJcsaFixtureRecord({date:'2026-09-25',venue:taif,meetingNo:19,checkedAt:'2026-09-21T12:00:00Z',officialUrl:'https://www.jcsa.sa/en/venues/our-racecourses-taif/'});
assert.equal(fixtureRecord.capability_rank,'C');
assert.equal(fixtureRecord.acquisition_completion,undefined);
assert.equal(fixtureRecord.acquisition_attempt.status,'pending_publication');
