...
for (const marker of ['--allow-empty', 'RACECOURSES_CLASSIFIED', 'PROMOTION_ELIGIBLE: 0', 'PUBLICATION_EFFECT: none', 'forbidden key fragment']) {
...
console.log('SCHEDULE_LINK_NORMALIZATION: guarded');
