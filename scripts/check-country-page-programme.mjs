...
for (const [status, expected] of Object.entries({ published: 20, profile_ready: 24, source_tested: 0, note_reviewed: 0, page_qa: 0, not_started: 54 })) {
...
console.log('PROGRAMME_COUNTS: published=20 profile_ready=24 not_started=54');
