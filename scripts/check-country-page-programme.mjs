...
for (const [status, expected] of Object.entries({ published: 68, profile_ready: 0, source_tested: 8, note_reviewed: 0, page_qa: 0, not_started: 22 })) {
...
console.log('PROGRAMME_COUNTS: published=68 page_qa=0 profile_ready=0 source_tested=8 note_reviewed=0 not_started=22');
