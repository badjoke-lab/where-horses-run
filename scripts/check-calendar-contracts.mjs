...
for (const [file, text, phrases] of [
  ...
  [paths.roadmap, roadmapText, ['Current Work ID: `WHR-PROFILE-69-76`', 'Next Work ID: `WHR-PUB-69-76`']],
  [paths.startHere, startHereText, ['WHR-NOTE-69-76', 'WHR-PROFILE-69-76', 'WHR-PUB-69-76']],
]) {
