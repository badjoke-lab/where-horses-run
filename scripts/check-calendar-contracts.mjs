...
for (const [file, text, phrases] of [
  ...
  [paths.roadmap, roadmapText, ['Current Work ID: `WHR-CAL-CONTRACT-02`', 'Next Work ID: `WHR-CP-PUB-29-36`']],
  [paths.startHere, startHereText, ['WHR-CAL-CONTRACT-02', 'WHR-CP-PUB-29-36']],
]) {
