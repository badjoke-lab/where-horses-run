...
for (const [file, text, phrases] of [
  ...
  [paths.roadmap, roadmapText, ['Current Work ID: `WHR-CAL-BACKFILL-21-36`', 'Next Work ID: `WHR-CAL-BACKFILL-37-52`']],
  [paths.startHere, startHereText, ['WHR-CAL-BACKFILL-21-36', 'WHR-CAL-BACKFILL-37-52']],
]) {
