...
assert.match(list, /stale: 'Stale data'/);
assert.match(list, /stale: '古い可能性あり'/);
assert.match(list, /2\+ days old/);
assert.match(list, /2日以上前/);
...
console.log('- stale warning renders once per meeting list while row check dates remain visible');
