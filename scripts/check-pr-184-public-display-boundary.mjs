...
if (policy.detail_page_policy?.avoid_racecard_presentation !== true) stop('Detail policy must avoid full-card presentation.');
...
for (const snippet of [
  ...
  'one meeting per row',
  'A+ race-by-race programme summaries must not be expanded on list pages',
