...
for (const [file, markers] of Object.entries({
  ...
  'docs/calendar/implementation-roadmap.md':['Status: complete','Pipeline v1 status: complete','Dynamic Dates status: complete','Operations v1 status: complete','Current Work ID: `WHR-CAL-JAPAN-JRA`'],
  'docs/project-roadmap.md':['Current Work ID: `WHR-CAL-JAPAN-JRA`','Completed Work ID: `WHR-CAL-OPS-V1`'],
  'START-HERE.md':['Previous completed Work ID: `WHR-CAL-OPS-V1`','WHR-CAL-JAPAN-JRA','WHR-CAL-JAPAN-NAR'],
})) {
