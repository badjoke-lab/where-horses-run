...
for (const [file, markers] of Object.entries({
  ...
  'docs/calendar/implementation-roadmap.md':['Pipeline v1 status: complete','Dynamic Dates status: complete','Operations v1 status: complete','Current Work ID: `WHR-CAL-JAPAN-NAR-A-PLUS`','Next Work ID: `WHR-CAL-JAPAN-BANEI-A-PLUS`','docs/calendar/incremental-coverage-contract.md'],
  'docs/project-roadmap.md':['Current Work ID: `WHR-CAL-JAPAN-NAR-A-PLUS`','Next Work ID: `WHR-CAL-JAPAN-BANEI-A-PLUS`','Completed Work ID: `WHR-CAL-OPS-V1`','Meeting / Schedule Layer'],
  'START-HERE.md':['Previous completed implementation Work ID: `WHR-CAL-JAPAN-JRA`','WHR-CAL-JAPAN-NAR','WHR-CAL-JAPAN-BANEI','docs/calendar/incremental-coverage-contract.md'],
})) {
