...
for (const phrase of ['Previous completed Work ID: `WHR-AUDIT-COUNTRY-CALENDAR-98`', 'WHR-CAL-BASELINE-RECONCILE']) if (!start.includes(phrase)) errors.push('START-HERE missing ' + phrase);
for (const phrase of ['Country-page programme: complete', 'Current Work ID: `WHR-CAL-BASELINE-RECONCILE`', '98 EN + 98 JA = 196']) if (!roadmap.includes(phrase)) errors.push('roadmap missing ' + phrase);
