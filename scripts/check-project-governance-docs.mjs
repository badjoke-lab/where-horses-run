...
for (const phrase of ['WHR-PROFILE-69-76', 'WHR-PUB-69-76', 'WHR-ST2-77-84']) if (!start.includes(phrase)) errors.push('START-HERE missing ' + phrase);
for (const phrase of ['Current Work ID: `WHR-PUB-69-76`', 'Next Work ID: `WHR-ST2-77-84`', 'WHR-AUDIT-COUNTRY-CALENDAR-98', 'WHR-CAL-BASELINE-RECONCILE', 'WHR-CAL-PUBLIC-V1']) if (!roadmap.includes(phrase)) errors.push('roadmap missing ' + phrase);
