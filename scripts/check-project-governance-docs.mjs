...
for (const phrase of ['Previous completed Work ID: `WHR-CAL-PIPELINE-V1`', 'WHR-CAL-DYNAMIC-DATES', 'WHR-CAL-OPS-V1']) if (!start.includes(phrase)) errors.push('START-HERE missing ' + phrase);
for (const phrase of ['Country-page programme: complete', 'Current Work ID: `WHR-CAL-DYNAMIC-DATES`', 'Completed Work ID: `WHR-CAL-PIPELINE-V1`', 'WHR-CAL-BASELINE-RECONCILE', '98 EN + 98 JA = 196']) if (!roadmap.includes(phrase)) errors.push('roadmap missing ' + phrase);
