...
for (const phrase of ['WHR-ST2-69-76', 'WHR-NOTE-69-76', 'WHR-PROFILE-69-76']) if (!start.includes(phrase)) errors.push('START-HERE missing ' + phrase);
for (const phrase of ['Current Work ID: `WHR-NOTE-69-76`', 'Next Work ID: `WHR-PROFILE-69-76`', 'WHR-AUDIT-COUNTRY-CALENDAR-98', 'WHR-CAL-BASELINE-RECONCILE', 'WHR-CAL-PUBLIC-V1']) if (!roadmap.includes(phrase)) errors.push('roadmap missing ' + phrase);
...
console.log('CURRENT_WORK_ID: WHR-NOTE-69-76');
console.log('NEXT_WORK_ID: WHR-PROFILE-69-76');
