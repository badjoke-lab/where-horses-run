...
const outputDir = path.join(process.cwd(), 'artifacts/rendered-preview-85-92');
fs.mkdirSync(outputDir, { recursive: true });
const slugs = ['ghana','saint-kitts-and-nevis','jordan','iraq','azerbaijan','mongolia','botswana','costa-rica'];
const representatives = new Set(['ghana','saint-kitts-and-nevis','mongolia','costa-rica']);
...
console.log('RENDERED_PREVIEW_85_92_VALID routes=16 viewport_checks=32 screenshots=16 errors=0');
