...
const expected = [
  ['37', 'malaysia', 'Malaysia', 'C'],
  ['38', 'thailand', 'Thailand', 'C'],
  ['39', 'philippines', 'Philippines', 'C'],
  ['40', 'mauritius', 'Mauritius', 'C'],
  ['41', 'argentina', 'Argentina', 'C'],
  ['42', 'germany', 'Germany', 'C'],
  ['43', 'italy', 'Italy', 'C'],
  ['44', 'spain', 'Spain', 'C']
];
...
console.log('COUNTRY_NOTES_37_44_VALID');
