export function parseEquibaseFullRacecard(html, options = {}) {
  ...
  for (const section of html.matchAll(sectionRegex)) {
    ...
    records.push({
      ...
      races,
      source_url: 'fixture:us-equibase-racecard-full',
      source_type: 'official_racecard_fixture',
      source_capture_date: sourceCaptureDate,
      last_checked: sourceCaptureDate,
      parser: 'equibase-full-racecard',
      promotion_note: 'Full racecard fixture exposes all race rows and race times for this meeting.'
    });
  }
