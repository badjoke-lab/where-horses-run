...
const OUTPUT = 'data/candidates/hkjc-september-2026-09-20-fixture-approved.json';
const REVIEWED_AT = '2026-08-23T04:45:00Z';
const REVIEWER = 'badjoke-lab';
const BATCH_ID = 'due-job-plan-2026-08-23-due-hong-kong-hkjc-season-wake-up-001-run-001';
const GENERATED_AT = '2026-08-23T04:04:59.500Z';
const CANDIDATES_BLOB_SHA = 'f44210e476d32c9463a37748ff12a06e28a80131';
const REPORT_BLOB_SHA = '38f51e969a00fe7d46bb4cacb70fbdcc317c4f59';
const MEETING_ID = 'hkjc-sha-tin-racecourse-2026-09-20';
...
assert(report.requested_scope?.start_date === '2026-09-17', 'HKJC scope start differs');
assert(report.requested_scope?.end_date_exclusive === '2026-09-22', 'HKJC scope end differs');
...
assert(source.candidate_window?.start_date === '2026-09-17' && source.candidate_window?.end_date_exclusive === '2026-09-22', 'HKJC candidate window differs');
...
assert(candidate.racecourse_id === 'sha-tin-racecourse' && candidate.date === '2026-09-20', 'HKJC meeting coordinates differ');
...
const output = {
  ...
  adapter_id: 'hkjc-september-2026-09-20-reviewed-fixture-promotion-v1',
  country_id: 'hong-kong',
  authority_id: 'hkjc',
  source_id: 'hkjc-fixture-list',
  candidate_window: {
    start_date: '2026-09-20',
    end_date_exclusive: '2026-09-21',
  ...
  review: {
    ...
    reviewer: REVIEWER,
    summary: 'Approved exactly one HKJC September 20 Sha Tin fixture meeting identity at Rank C from pinned August 23 artifact evidence; no race times or programme rows are claimed.',
