...
function publicMeetingRecord(meeting, detail) {
  ...
  return {
    ...
    date: meeting.date,
    timezone: 'Asia/Tokyo',
    capability_rank: effectivePublicRank,
    max_public_rank: effectivePublicRank,
...
function publicDetailRecord(meeting, detail, publicMeeting) {
  ...
  return {
    ...
    date: meeting.date,
    timezone: 'Asia/Tokyo',
    capability_rank: publicMeeting.effective_public_rank,
    max_public_rank: publicMeeting.effective_public_rank,
