...
const FUTURE_PAGE = 'https://www.tjk.org/TR/Kurumsal/Info/Page/GunlukYarisProgrami?Era=tomorrow&QueryParameter_Tarih=15%2F08%2F2026';

const entryHtml = `
<a href="/TR/Kurumsal/Info/Sehir/GunlukYarisProgrami?Era=today&amp;QueryParameter_Tarih=14%2F08%2F2026&amp;SehirAdi=Ankara&amp;SehirId=5">Ankara (50. Y.G.)</a>
<a href="/TR/Kurumsal/Info/Sehir/GunlukYarisProgrami?Era=today&amp;QueryParameter_Tarih=14%2F08%2F2026&amp;SehirAdi=Delaware%20Park&amp;SehirId=90">Delaware Park ABD (YD 4)</a>
<a href="/TR/Kurumsal/Info/Sehir/GunlukYarisProgrami?Era=yesterday&amp;QueryParameter_Tarih=13%2F08%2F2026&amp;SehirAdi=Kocaeli&amp;SehirId=9">Kocaeli (25. Y.G.)</a>
<a href="https://evil.example/TR/Kurumsal/Info/Sehir/GunlukYarisProgrami?QueryParameter_Tarih=14%2F08%2F2026&amp;SehirAdi=Ankara&amp;SehirId=5">Ankara clone</a>
<a href="${FUTURE_PAGE.replaceAll('&', '&amp;')}">15.08.2026</a>`;

const futureHtml = `
<a href="/TR/Kurumsal/Info/Sehir/GunlukYarisProgrami?Era=tomorrow&amp;QueryParameter_Tarih=15%2F08%2F2026&amp;SehirAdi=%C4%B0stanbul&amp;SehirId=3">İstanbul (50. Y.G.)</a>`;
...
test('discovers only non-past domestic TJK city programme anchors', () => {
...
test('collects current and fetchable future index pages without synthesizing URLs', async () => {
...
test('validator fails closed for provenance, host, past date, duplicate, publication and retained payload violations', async () => {
  const artifact = await collectCandidateBatch({ fetchImpl: fakeFetch, now: NOW });
